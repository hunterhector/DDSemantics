...
python -m event.arguments.prepare.event_vocab --input_data ${implicit_corpus}/gigaword_events/nyt_events.json.gz --vocab_dir ${implicit_corpus}/gigaword_events/vocab --sent_out ${implicit_corpus}/gigaword_events/event_sentences --prop_arg
...
echo "Creating predicate only embeddings"
