...
if "srl_workspace" not in os.environ:
    raise KeyError(
        "Please supply the directory as environment " "variable: 'srl_workspace'"
    )
else:
    base = os.environ["srl_workspace"]

c.SrlResources.word_embedding_path = (
    "/home/zhengzhl/workspace/resources/embeddings/glove.6B/glove.test.txt"
)
